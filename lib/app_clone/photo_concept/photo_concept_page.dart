...
class PhotoConceptPage extends StatefulWidget {
  const PhotoConceptPage({super.key});

  @override
  State<PhotoConceptPage> createState() => _PhotoConceptPageState();
}
...
class _PhotoConceptPageState extends State<PhotoConceptPage> {
  ...
  Widget build(BuildContext context) {
    ...
    const vSeparator = SizedBox(height: 5);
    final borderRadius = BorderRadius.circular(20.0);

    double percentBackground;
    double currentPercentage;
    if (expanded) {
      currentPercentage = topPercentageBefore;
      percentBackground = 1.0;
    } else {
      currentPercentage = topPercentageAfter;
      percentBackground = 0.8;
    }
    final topHeight = size.height * currentPercentage;
    final bottomHeight = size.height * (1 - currentPercentage);
    const duration = Duration(milliseconds: 500);
    final imageSize = _heightImage * percentBackground;
    final backgroundSize = _heightBackGround * percentBackground;
    return Scaffold(
        ...
        children: [
          ...
          AnimatedContainer(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  _buildList(uRLANIMALIMAGES1),
                  vSeparator,
                  _buildList(uRLANIMALIMAGES2),
                  vSeparator,
                  _buildList(uRLANIMALIMAGES3),
                  vSeparator,
                  _buildList(urlAnimalImages4),
                  vSeparator,
                ],
              ),
            ),
