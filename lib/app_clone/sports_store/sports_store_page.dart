...
import 'package:buttons/app_clone/sports_store/sports_store_detail_page.dart';
...
class SportsStorePage extends StatefulWidget {
  const SportsStorePage({super.key});

  @override
  State<SportsStorePage> createState() => _SportsStorePageState();
}
...
class _SportsStorePageState extends State<SportsStorePage> {
  ...
  Widget _buildHeader() {
    Widget buildGroup(bool selected, IconData icon) {
      return Row(
        children: [
          Icon(
            icon,
        ...
        Padding(
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Row(children: [
                buildGroup(true, Icons.battery_charging_full),
                const SizedBox(
                  width: 20,
                ),
                buildGroup(false, Icons.shopping_basket),
              ]),
            ),
          ),
        ),
