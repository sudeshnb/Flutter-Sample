...
import 'package:buttons/app_clone/album_flow/album_flow_detail_page.dart';
...
class AlbumFlowPage extends StatefulWidget {
  const AlbumFlowPage({super.key});

  @override
  State<AlbumFlowPage> createState() => _AlbumFlowPageState();
}
