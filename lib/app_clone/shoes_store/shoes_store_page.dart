...
const shoesBottom = [
  Shoe(name: 'NIKE AIR-MAX', price: 170.00, image: 'images/shoes/3.png'),
  Shoe(name: 'NIKE AIR FORCE', price: 130.00, image: 'images/shoes/4.png'),
];

class ShoesStorePage extends StatefulWidget {
  const ShoesStorePage({super.key});

  @override
  State<ShoesStorePage> createState() => _ShoesStorePageState();
}
...
class _ShoesStorePageState extends State<ShoesStorePage> {
  ...
  Widget _buildBottom(BuildContext context) {
    Widget buildBottomItem(Shoe shoe) => Card(
          elevation: 4,
          child: Stack(
            children: [
              Center(
          ...
          children: [
            ...
            Expanded(
              child: Row(
                children: [
                  Expanded(
                    child: buildBottomItem(shoesBottom.first),
                  ),
                  const SizedBox(
                    width: 10,
                  ),
                  Expanded(
                    child: buildBottomItem(shoesBottom.last),
                  ),
                ],
              ),
            ),
  ...
  Widget build(BuildContext context) {
    Widget buildLeftItem(String title, bool selected) => Text(
          title,
          style: TextStyle(
            fontWeight: FontWeight.w700,
                  ...
                  child: Padding(
                    ...
                    child: RotatedBox(
                      ...
                      child: Row(
                        ...
                        children: [
                          buildLeftItem('New', false),
                          leftItemSeparator,
                          buildLeftItem('Featured', true),
                          leftItemSeparator,
                          buildLeftItem('Upcoming', false),
                        ],
                      ),
                    ),
                  ),
