...
import 'package:buttons/hero_animations/hero_dialog_route.dart';
import 'package:buttons/hero_animations/page1.dart';
import 'package:buttons/hero_animations/page2.dart';

class MainHeroAnimationsPage extends StatefulWidget {
  const MainHeroAnimationsPage({super.key});

  @override
  State<MainHeroAnimationsPage> createState() => _MainHeroAnimationsPageState();
}
...
class CustomLogo extends StatelessWidget {
  ...
  const CustomLogo({super.key, this.size = 200.0});
